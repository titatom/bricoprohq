...
OAUTH_PROVIDERS: dict[str, dict] = {
    ...
    "meta": {
        ...
        # Facebook Login scopes for Page management; Instagram publishing uses the
        # separate "instagram" provider below (Instagram API with Instagram Login).
        "scopes": [
            "pages_show_list",
    ...
    # Instagram API with Instagram Login — uses instagram_business_* scopes and
    # a separate authorization endpoint.  Credentials (App ID / Secret) are
    # shared from the "meta" integration row via _META_PROVIDERS.
